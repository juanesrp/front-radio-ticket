...
const FormNewEvent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      ...
      !input.address ||
      !input.longitude ||
      !input.tickets[0].price ||
      !input.tickets[0].stock ||
      !input.tickets[0].zone ||
      !image
    ) {
    ...
    <>
      <div className="flex flex-col items-center my-16">
        <form
          ...
          className="flex gap-4 max-[500px]:flex-col"
        >
          <div className="bg-gray-100 max-w-md w-full flex flex-col min-[500px]:px-12 px-6 py-8 rounded-md shadow-md">
            ...
            <div className="flex flex-col">
              <label
                htmlFor="name"
                className="text-gray-700 font-semibold my-2"
              >
                Nombre del evento*
              </label>
              <input
          ...
          <div className="bg-gray-100 flex flex-col min-[500px]:px-10 px-4 py-8 rounded-md shadow-md">
            ...
            {input.tickets.map((ticket, index) => (
              <div
                key={index}
                className="flex flex-col border border-gray-300 p-4 my-2 rounded-md"
              >
                <div className="flex flex-col">
                  <label
                    htmlFor={`stock-${index}`}
