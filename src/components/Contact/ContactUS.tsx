...
const ContactUS: React.FC = () => {
    ...
    const handleTextAreaChange = (event: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        console.log(`Textarea ${event.target.name} changed:`, event.target.value);
    };
        ...
        <form ref={formRef} onSubmit={sendEmail}>
            <div className="max-w-4xl mx-auto p-6 bg-gray-100 rounded-lg shadow-md mt-16 mb-16">
                ...
                <p className="mb-6 text-xl">
                    Para resolver todas tus dudas sobre nuestros productos y eventos deja tus
                    datos para poder comunicarnos contigo.
                </p>
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label htmlFor="nombre" className="text-gray-700 font-semibold mb-2 block text-xl">
                            Nombre
                        </label>
                        <input
                            type="text"
                ...
                <div className="mb-4">
                    <label htmlFor="telefono" className="text-gray-700 font-semibold mb-2 block text-xl">
                        Número de teléfono
                    </label>
                    <input
                        type="number"
                ...
                <div className="mb-4">
                    <label htmlFor="mensaje" className="text-gray-700 font-semibold mb-2 block text-xl">
                        Mensaje
                    </label>
                    <textarea
