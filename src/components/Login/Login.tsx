  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="max-w-lg w-full px-10 py-12 bg-gray-100 rounded-lg shadow-md">
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-8">INGRESAR</h1>
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            <label htmlFor="email" className="text-gray-700 font-semibold mb-2 block text-xl">
              Correo electrónico
            </label>
            <input
              type="email"
          ...
          <div className="mb-6">
            <label htmlFor="password" className="text-gray-700 font-semibold mb-2 block text-xl">
              Contraseña
            </label>
