...
const Chatbot = () => {
    ...
    const [selectedOption, setSelectedOption] = useState<keyof typeof secondaryOptions | null>(null);
        ...
        setTimeout(() => {
            ...
            switch (message) {
                case '¿Dónde llegan mis tickets?':
                    botResponse = 'Tus tickets llegarán al correo electrónico asociado con el que te registraste.';
                    break;
                ...
                case '¿Qué beneficios tiene ser premium?':
                    botResponse = 'Como usuario premium, tienes la ventaja de comprar los tickets días antes de su lanzamiento.';
                    break;
                case '¿Cómo puedo mostrar mi ticket?':
                    botResponse = 'Puedes mostrar tu ticket revisando el PDF enviado, el cual contiene todos los detalles junto con un código QR.';
                    break;
                ...
                case '¿Por qué comprar los tickets antes del lanzamiento?':
                    botResponse = 'Al comprar tus tickets antes del lanzamiento general, puedes encontrar mejores ubicaciones y aprovechar descuentos al momento de la compra.';
                    break;
                case '¿Qué descuentos se ofrecen?':
                    botResponse = 'Como usuario premium, puedes obtener descuentos en ciertos eventos.';
                    break;
    ...
    const options = stage === 'initial' ? initialOptions : (selectedOption ? secondaryOptions[selectedOption] || [] : []);
